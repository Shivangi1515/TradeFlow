    ...
    return (
        ...
        <div className='container border-top mt-5'>
            <div className='row mt-5'>
                <div className='col'>
                    <img src="media/images/TradeFlow.png" style={{ width: "50%" }} />
                    <p>&copy; 2010 - 2026, Trade Broking Ltd. All rights reserved.</p>
                </div>
            ...
            <p>TradeFlow Broking Ltd.: Member of NSE, BSE, MCX & MSEI – SEBI Registration no.: INZ000031633 CDSL/NSDL: Depository services through TradeFlow Broking Ltd. – SEBI Registration no.: IN-DP-431-2019 Registered Address: TradeFlow Broking Ltd., #153/154, 4th Cross, Dollars Colony, Opp. Clarence Public School, J.P Nagar 4th Phase, Bengaluru - 560078, Karnataka, India. For any complaints pertaining to securities broking please write to complaints@tradeflow.com, for DP related to dp@tradeflow.com. Please ensure you carefully read the Risk Disclosure Document as prescribed by SEBI | ICF</p>
