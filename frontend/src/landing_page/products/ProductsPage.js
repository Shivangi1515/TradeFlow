...
function ProductsPage() {
    return (
        <>
            ...
            <RightSection imageURL="media/images/console.png" productName="Console" productDescription="The central dashboard for your TradeFlow account. Gain insights into your trades and investments with in-depth reports and visualisations." learnMore="" />
            ...
            <p className='text-center mt-5 mb-5'>Want to know more about our technology stack? Check out the TradeFlow.tech blog.
